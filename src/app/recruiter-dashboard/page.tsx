...
export const page = () => {
  return (
    <div className="bg-background text-on-surface antialiased">
      <aside className="h-screen w-64 fixed left-0 top-0 bg-slate-50 dark:bg-slate-900 border-r border-slate-200/50 dark:border-slate-800/50 flex flex-col h-full py-8 px-4 z-50">
      ...
      <header className="fixed top-0 right-0 w-[calc(100%-16rem)] h-16 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md flex items-center justify-between px-8 z-40 shadow-sm dark:shadow-none">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <img
              ...
              data-alt="professional headshot of a recruitment executive in a sharp navy suit with modern office background"
