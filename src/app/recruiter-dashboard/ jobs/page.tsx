  ...
  return (
    <div className="bg-background text-on-surface flex min-h-screen">
      ...
      <main className="flex-1 ml-64 min-h-screen flex flex-col">
        ...
        <footer className="w-full py-6 mt-auto flex justify-between items-center px-8 w-[calc(100%-16rem)] ml-64 border-t border-slate-100 dark:border-slate-800 bg-transparent">
          <p className="text-xs font-medium uppercase tracking-widest text-slate-400">
            © 2024 Editorial Executive Recruitment. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <a
              className="text-xs font-medium uppercase tracking-widest text-slate-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition-opacity"
              href="#"
            >
              Legal
            </a>
