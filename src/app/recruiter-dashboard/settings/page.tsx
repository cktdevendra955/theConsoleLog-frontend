...
const page = () => {
  return (
    <div className="bg-background text-on-surface min-h-screen">
      ...
      <main className="ml-64 pt-24 pb-12 px-8 max-w-7xl">
        <div className="mb-12">
          <h2 className="text-4xl font-bold tracking-tight text-on-surface mb-2">
            Management Workspace
          </h2>
          <p className="text-on-surface-variant max-w-2xl text-lg leading-relaxed">
            Refine your agency's digital presence and harmonize your recruitment
            team within a high-performance environment.
          </p>
        </div>
        <div className="flex gap-8 mb-10 border-b border-outline-variant/20">
          <button className="pb-4 text-sm font-semibold text-primary border-b-2 border-primary transition-all">
            Company Profile
          </button>
          <button className="pb-4 text-sm font-medium text-slate-500 hover:text-primary transition-all">
            Team Management
          </button>
          <button className="pb-4 text-sm font-medium text-slate-500 hover:text-primary transition-all">
            Hiring Preferences
        ...
        <div className="grid grid-cols-12 gap-10">
          <div className="col-span-12 lg:col-span-8 space-y-10">
            <section className="bg-surface-container-lowest rounded-xl p-8 editorial-shadow">
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-8 p-6 bg-surface-container-low rounded-xl">
                  <div className="relative">
                    <img
                      alt="Company logo placeholder"
                      className="w-24 h-24 rounded-lg object-cover shadow-sm bg-white"
                      data-alt="minimalist modern geometric brand logo design with clean lines and premium aesthetic"
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      className="w-full bg-transparent border-0 border-b-2 border-outline-variant/20 focus:border-primary focus:ring-0 px-0 py-2 text-sm font-medium"
                      type="text"
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full bg-transparent border-0 border-b-2 border-outline-variant/20 focus:border-primary focus:ring-0 px-0 py-2 text-sm font-medium appearance-none">
                ...
                <div className="space-y-2">
                  ...
                  <textarea className="w-full bg-transparent border-0 border-b-2 border-outline-variant/20 focus:border-primary focus:ring-0 px-0 py-2 text-sm leading-relaxed">
                    We are a boutique executive search firm dedicated to
                    connecting visionary leaders with high-impact roles. Our
                    editorial approach ensures every placement is a strategic
                    masterpiece.
                  </textarea>
                </div>
              </div>
            ...
            <section className="bg-surface-container-lowest rounded-xl p-8 editorial-shadow">
              <div className="flex justify-between items-center mb-8">
                ...
                <button className="bg-primary text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:opacity-90 transition-opacity flex items-center gap-2">
                  <span className="material-symbols-outlined text-sm">
                    person_add
                  </span>
                  Invite Recruiter
                ...
                <div className="py-4 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <img
                      ...
                      data-alt="professional male executive portrait with warm lighting and a soft focus blurred office background"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuDVYe3xI3U49wzDa6W2-bLTptMAfhdt3uZ4DCmxtMGItRKyQ1eU0wZOeWO7Q83ZfOSE7BNL5cfZa6N6RU-iMfkrTMYr6oh8e5_im8YddCvrIM88EK-UuV4MHmzvpdXEZQDkwXQX6ZMYLDlC7LvCyoHlnc287ieIIBimTWKmk6nkVJY6NZXeEkHPfNQwrjei-vvA9nKMO-EOht996hAujapxXGUIjIOMVOhYwPfF9eTs5ix8ztg75FXduhZ81X-_GxeeD97ipMQTbzdM"
                    />
                    <div>
                      <p className="text-sm font-bold">Marcus Sterling</p>
                      <p className="text-xs text-slate-500">
                        m.sterling@executive.com
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex justify-end gap-4">
              <button className="px-8 py-3 rounded-xl border border-outline-variant/30 text-sm font-bold text-slate-500 hover:bg-slate-50 transition-colors">
                Discard Changes
              </button>
              <button className="px-10 py-3 rounded-xl bg-primary text-white text-sm font-bold shadow-lg shadow-primary/20 hover:scale-[1.02] transition-transform">
          ...
          <div className="col-span-12 lg:col-span-4 space-y-8">
            <div className="bg-indigo-900 text-white p-8 rounded-2xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-indigo-200 text-sm leading-relaxed mb-6">
                  ...
                  from passive candidates in our exclusive talent pool.
                </p>
            ...
            <div className="bg-surface-container-high/50 border border-outline-variant/20 p-8 rounded-xl">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-semibold">Zoom / Teams</p>
                  </div>
                  <button className="text-primary text-xs font-bold">
                    Change
                  </button>
                ...
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-semibold text-error">Disabled</p>
                  </div>
                  <button className="text-primary text-xs font-bold">
                    Configure
                  </button>
