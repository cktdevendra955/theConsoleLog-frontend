  ...
  return (
    <div className="bg-background text-on-surface overflow-hidden">
      ...
      <main className="ml-64 pt-16 h-screen flex">
        <section className="w-[380px] h-full flex flex-col bg-surface-container-low border-r border-outline-variant/20 overflow-hidden">
          <div className="p-6 border-b border-outline-variant/10">
            ...
            <div className="flex gap-2">
              <button className="px-3 py-1.5 rounded-full bg-white text-xs font-semibold shadow-sm text-primary">
                All
              </button>
              <button className="px-3 py-1.5 rounded-full text-xs font-medium text-slate-500 hover:bg-white hover:shadow-sm transition-all">
                Unread
              </button>
              <button className="px-3 py-1.5 rounded-full text-xs font-medium text-slate-500 hover:bg-white hover:shadow-sm transition-all">
                Starred
              ...
              <div className="flex gap-4">
                <div className="relative flex-shrink-0">
                  <img
                    ...
                    data-alt="headshot of a stylish professional woman with creative flair in a studio setting with warm lighting"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-on-surface-variant line-clamp-1 mb-1">
                    I've attached the revised portfolio deck with the editorial
                    case studies.
                  </p>
              ...
              <div className="flex gap-4">
                <div className="relative flex-shrink-0">
                  <img
                    ...
                    data-alt="professional male portrait with a friendly smile wearing a charcoal suit in a minimalist grey background"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500 line-clamp-1">
                    That interview time works perfectly for me. See you on
                    Monday!
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <div className="relative flex-shrink-0">
                  <img
                    alt="Candidate"
                    className="w-12 h-12 rounded-xl object-cover"
                    data-alt="professional woman in her 30s with a sharp, intelligent look wearing glasses in a modern library setting"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-on-surface font-semibold line-clamp-1">
                    Waiting on the contract details before I can finalize the
                    offer...
                  </p>
                </div>
              </div>
            ...
            <div className="p-5 hover:bg-surface-container-high transition-all cursor-pointer group opacity-70">
              <div className="flex gap-4">
                <img
                  ...
                  data-alt="young executive male looking thoughtful in a modern glass-walled boardroom with blurred city lights in background"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500 line-clamp-1">
                    Thank you for reaching out, but I've recently accepted a
                    role at...
                  </p>
                </div>
              </div>
        ...
        <section className="flex-1 flex flex-col bg-surface relative overflow-hidden">
          <header className="h-20 px-10 border-b border-outline-variant/10 flex items-center justify-between bg-white/50 backdrop-blur-sm z-10">
            ...
            <div className="flex items-center gap-4">
              <button className="flex items-center gap-2 px-4 py-2 rounded-lg text-primary bg-indigo-50 hover:bg-indigo-100 transition-colors text-xs font-semibold">
              ...
              <div className="max-w-md">
                <div className="bg-primary text-white px-5 py-4 rounded-2xl rounded-tr-none shadow-sm">
                  <p className="text-sm leading-relaxed">
                    Hi Helena, I've had a chance to review your initial case
                    studies. The luxury branding piece for 'The Sovereign' was
                    particularly impressive. Could you share the metrics for
                    that campaign?
                  </p>
                </div>
            ...
            <div className="flex justify-start gap-3">
              ...
              <div className="max-w-md">
                <div className="bg-surface-container-low text-on-surface px-5 py-4 rounded-2xl rounded-tl-none border border-outline-variant/10">
                  <p className="text-sm leading-relaxed">
                    Absolutely! I'm glad that caught your eye. We saw a 45%
                    increase in high-net-worth engagement within the first
                    quarter. I've attached a detailed breakdown of the KPIs and
                    the editorial strategy below.
                  </p>
                </div>
          ...
          <footer className="p-8 bg-white border-t border-outline-variant/10">
            <div className="max-w-4xl mx-auto">
              <div className="bg-surface-container-low rounded-2xl p-2 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all border border-transparent focus-within:border-primary/20">
                <textarea
                ...
                <div className="flex items-center justify-between mt-2 px-2 pb-1">
                  <div className="flex items-center gap-1">
                    <button className="p-2 text-slate-500 hover:text-primary transition-colors rounded-lg hover:bg-white">
                      <span className="material-symbols-outlined">
                        attach_file
                      </span>
                    </button>
                    ...
                    <button className="p-2 text-slate-500 hover:text-tertiary transition-colors rounded-lg hover:bg-white">
                      <span className="material-symbols-outlined">
                        schedule_send
                      </span>
                    </button>
                  </div>
                  <button className="bg-primary text-white px-6 py-2 rounded-xl text-xs font-bold shadow-sm hover:opacity-90 active:scale-95 transition-all flex items-center gap-2">
                    Send Message
                    <span className="material-symbols-outlined text-sm">
                      send
                    </span>
