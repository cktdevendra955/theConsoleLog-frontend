      ...
      <main className="min-h-screen">
        ...
        <section className="pt-24 px-8 pb-12 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
            <div>
              <h2 className="text-[3.5rem] font-bold tracking-[-0.04em] leading-[1.1] text-on-surface mb-2">Track Application</h2>
              <p className="text-body-lg text-on-surface-variant max-w-lg leading-relaxed">
                Managing 12 active opportunities. You have 2 interviews scheduled for this week.
              </p>
            </div>
          ...
          <div className="bg-surface-container-low rounded-2xl p-4 flex flex-wrap items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 md:pb-0">
              ...
              <button className="px-5 py-2 rounded-full hover:bg-white/50 text-on-surface-variant text-sm font-medium transition-all whitespace-nowrap">Shortlisted (5)</button>
              <button className="px-5 py-2 rounded-full hover:bg-white/50 text-on-surface-variant text-sm font-medium transition-all whitespace-nowrap">Archived (4)</button>
            </div>
            <div className="flex items-center gap-3 ml-auto">
              <div className="relative">
                <select className="appearance-none bg-white border-none rounded-xl py-2 pl-4 pr-10 text-sm font-medium text-on-surface-variant focus:ring-2 focus:ring-primary/20 cursor-pointer shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="hidden md:grid grid-cols-12 px-8 py-3 text-[0.75rem] font-bold tracking-[0.05em] uppercase text-outline">
              ...
              <div className="col-span-3">Next Step / Timeline</div>
            ...
            <div className="bg-surface-container-lowest rounded-2xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 items-center gap-6 shadow-premium group transition-all hover:bg-white">
              <div className="col-span-4 flex items-center gap-5">
                ...
                <div>
                  <h4 className="text-title-lg font-semibold text-on-surface">Senior Product Designer</h4>
                  <p className="text-body-lg text-on-surface-variant">Linear • Hybrid</p>
                </div>
              </div>
              ...
              <div className="col-span-2 flex justify-center">
                <span className="bg-primary/5 text-primary px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider">Shortlisted</span>
              </div>
              ...
              <div className="col-span-1 text-right">
                <button className="w-10 h-10 rounded-full hover:bg-surface-container transition-colors">
              ...
              <div className="col-span-4 flex items-center gap-5">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h4 className="text-title-lg font-semibold text-on-surface">Lead UX Researcher</h4>
                    <span className="material-symbols-outlined text-[goldenrod] text-sm">star</span>
                  </div>
                  <p className="text-body-lg text-on-surface-variant">Spotify • Remote</p>
                </div>
              </div>
              <div className="col-span-2">
              ...
              <div className="col-span-3">
                <div className="bg-surface-container-low rounded-xl p-3 flex items-center gap-3 border border-primary/10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-on-surface font-medium">Technical Round with Maya Chen</p>
                  </div>
                </div>
              </div>
              <div className="col-span-1 text-right">
            ...
            <div className="bg-surface-container-lowest rounded-2xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 items-center gap-6 shadow-premium group transition-all hover:bg-white opacity-80 hover:opacity-100">
              <div className="col-span-4 flex items-center gap-5">
                ...
                <div>
                  <h4 className="text-title-lg font-semibold text-on-surface">Interface Architect</h4>
                  <p className="text-body-lg text-on-surface-variant">Studio J • On-site</p>
                </div>
              </div>
              <div className="col-span-2">
              ...
              <div className="col-span-2 flex justify-center">
                <span className="bg-outline-variant/20 text-on-surface-variant px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider">Applied</span>
              </div>
              <div className="col-span-3">
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between text-xs font-semibold mb-1">
                  ...
                  <p className="text-[11px] text-on-surface-variant">Resume submitted, pending HR review</p>
                </div>
              </div>
              <div className="col-span-1 text-right">
                <button className="w-10 h-10 rounded-full hover:bg-surface-container transition-colors">
            ...
            <div className="bg-surface-container-lowest rounded-2xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 items-center gap-6 shadow-premium group transition-all opacity-60">
              <div className="col-span-4 flex items-center gap-5">
                ...
                <div>
                  <h4 className="text-title-lg font-semibold text-on-surface line-through">Product Strategist</h4>
                  <p className="text-body-lg text-on-surface-variant">X (Twitter) • Remote</p>
                </div>
              </div>
              <div className="col-span-2">
              ...
              <div className="col-span-2 flex justify-center">
                <span className="bg-error/5 text-error px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider">Rejected</span>
              </div>
              <div className="col-span-3">
                <p className="text-xs text-error font-medium leading-relaxed italic">"We've decided to move forward with other candidates who more closely align with our current needs."</p>
              </div>
              <div className="col-span-1 text-right">
                <button className="w-10 h-10 rounded-full hover:bg-surface-container transition-colors">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm font-bold text-on-surface">Design Challenge</p>
                      <p className="text-xs text-on-surface-variant">Due in 2 days • Figma</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-surface-container-low flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <p className="text-sm font-bold text-on-surface">Intro Video Submission</p>
                      <p className="text-xs text-on-surface-variant">Due in 5 days • Loom</p>
                    </div>
                  </div>
                </div>
              </div>
              <a className="text-primary text-sm font-bold flex items-center gap-2 mt-8 hover:translate-x-1 transition-transform" href="#">
                Go to Tasks <span className="material-symbols-outlined text-sm">arrow_forward</span>
              </a>
            </div>
          </div>
        </section>
